...
.sidebar {
  ...
  bottom: 0;
  width: 280px;
  background: linear-gradient(180deg, rgba(28, 28, 39, 0.95) 0%, rgba(19, 19, 26, 0.98) 100%);
...
.logo-icon {
  width: 52px;
  height: 52px;
  background: linear-gradient(135deg, var(--primary-500) 0%, var(--primary-600) 50%, #8b5cf6 100%);
  border-radius: 14px;
  display: flex;
  align-items: center;
