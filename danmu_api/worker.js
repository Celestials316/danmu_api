              ...
              <div class="scan-panel">
                ...
                <div class="scan-controls">
                  <div style="flex: 1; min-width: 120px;">
                    <input type="text" class="form-input" id="scanSubnet" placeholder="网段 (如 192.168.1)" value="192.168.1" style="font-family: monospace; padding: 8px 12px; font-size: 13px;">
                  </div>
                  <div style="width: 80px;">
                    <input type="text" class="form-input" id="scanPort" placeholder="端口" value="9978" style="font-family: monospace; padding: 8px 12px; font-size: 13px;">
                  </div>
                  <button class="btn btn-primary" onclick="startLanScan()" id="btnScan" style="padding: 8px 16px; font-size: 13px;">
                    <span id="scanBtnText">扫描</span>
                  </button>
                </div>
                
                <div class="form-hint" style="margin-top: 6px; font-size: 11px;">
                  常见端口: OK影视(9978), Kodi(8080), PotPlayer(8080)
                </div>
...
在 HTML 字符串底部的 `<script>` 标签内，在 `saveQuickConfig` 函数定义的**后面**，`</body>` 标签的**前面**，添加以下扫描逻辑代码：
