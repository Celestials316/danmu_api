...
    // ====================
    // [修改点 3]
    // 新增：如果值未设置（为 null 或 undefined），则在类型转换前直接返回
    if (value === null || value === undefined) {
      this.accessedEnvVars.set(key, value); // 记录访问
      return value;
    }
    // ====================
...
      // ====================
      // [修改点 4]
      // 将默认值 50 改为 null，这样在未设置时 Envs.get 会返回 null
      whiteRatio: this.get('WHITE_RATIO', null, 'number'), // 白色弹幕占比配置（0-100，null/未设置 表示不转换）
      // ====================
