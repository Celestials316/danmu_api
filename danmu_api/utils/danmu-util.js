...
export function convertToDanmakuJson(contents, platform) {
  ...
  if (whiteRatio >= 0 && whiteRatio <= 100) {
    ...
    // 定义彩色弹幕的颜色池
    const colorPalette = [
      16675739,  // 少女粉 #FE739B (B站经典粉，比纯洋红更柔和)
      16748340,  // 活力橙 #FF8F34 (明亮但不焦黑)
      16770637,  // 柠檬黄 #FFE14D (高亮醒目，阅读性强)
      563456,    // 护眼绿 #089880 (偏青的绿色，高级感)
      2338277,   // 天空蓝 #23ADE5 (清爽的天蓝色)
      10313455,  // 罗兰紫 #9D5EF7 (神秘且清晰)
      16726202,  // 珊瑚红 #FF34BA (介于红粉之间)
      48340,     // 蒂芙尼 #00BCD4 (清新的青色)
      2829099,   // 酷黑   #2B2B2B (特定场景使用)
    ];
